...
#'   (MACCS keys). Rows corresponding to invalid molecules contain \code{NA}.
#'
...
#'
#' @return
#'   A matrix of integers (0 or 1) with one row per molecule and \code{fp_size}
...
#'   A logical value. If set, whether or not the atom is in a ring will be used
